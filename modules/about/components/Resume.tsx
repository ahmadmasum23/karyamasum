...
const Resume = () => {
  ...
  const RESUME_URL = "https://www.canva.com/design/DAGnaMbRO7Y/_PhQaX-LmyztJOmP5A1c3g/edit?utm_content=DAGnaMbRO7Y&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton";

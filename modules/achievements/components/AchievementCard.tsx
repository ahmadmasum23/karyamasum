                ...
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="w-90 hidden flex-col border-l border-neutral-200 py-4 pl-8 pr-20 dark:border-neutral-800 md:flex">
                    ...
                    {url_credential && (
                      <Link
                        href={url_credential}
                        className="mt-6 flex w-fit justify-between gap-2 rounded-full bg-blue-500 px-3 py-3 text-dark transition duration-300 hover:scale-105 hover:bg-primary-400"
                      >
